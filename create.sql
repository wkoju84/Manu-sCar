create table bookings (id integer not null auto_increment, dropoff_date datetime(6), pickup_date datetime(6), customer_id integer, product_id integer, primary key (id)) engine=InnoDB;
create table categories (id integer not null auto_increment, description varchar(255), name varchar(255), rating integer, url varchar(255), primary key (id)) engine=InnoDB;
create table cities (id integer not null auto_increment, country varchar(255), name varchar(255), primary key (id)) engine=InnoDB;
create table customers (id integer not null auto_increment, last_name varchar(255), name varchar(255), user_id integer, primary key (id)) engine=InnoDB;
create table features (id integer not null auto_increment, icon varchar(255), name varchar(255), primary key (id)) engine=InnoDB;
create table images (id integer not null auto_increment, title varchar(255), url varchar(255), product_id integer, primary key (id)) engine=InnoDB;
...
create table products (id integer not null auto_increment, description varchar(255), name varchar(255), category_id integer, city_id integer, primary key (id)) engine=InnoDB;
create table roles (id integer not null auto_increment, name varchar(255), primary key (id)) engine=InnoDB;
create table users (id integer not null auto_increment, email varchar(255), password varchar(255), role_id integer, primary key (id)) engine=InnoDB;
...
alter table product_feature add constraint FKivggggffl6y2yngjpjmxjj2w8 foreign key (feature_id) references features (id);
alter table product_feature add constraint FKq8ry4ae6n92gkva697ioy5f9v foreign key (product_id) references products (id);
alter table products add constraint FKog2rp4qthbtt2lfyhfo32lsw9 foreign key (category_id) references categories (id);
alter table products add constraint FK1jpjau7sg3bb841s8e7e8o8ei foreign key (city_id) references cities (id);
...
INSERT INTO images(title, url, product_id) VALUES ('Chevrolet Onix',            'https://gitlab.com/JaiJuni0r/grupo_3/uploads/af8f3cf89772d0dac127d37533dd9960/image.png', 24);create table bookings (drop_off_date datetime(6), id bigint not null auto_increment, pick_up_date datetime(6), primary key (id)) engine=InnoDB;
create table categories (rating integer, id bigint not null auto_increment, description varchar(255), name varchar(255), url varchar(255), primary key (id)) engine=InnoDB;
create table cities (id bigint not null auto_increment, country varchar(255), name varchar(255), primary key (id)) engine=InnoDB;
create table customers (id bigint not null auto_increment, last_name varchar(255), name varchar(255), primary key (id)) engine=InnoDB;
create table features (id bigint not null auto_increment, icon varchar(255), name varchar(255), primary key (id)) engine=InnoDB;
create table images (id bigint not null auto_increment, title varchar(255), url varchar(255), primary key (id)) engine=InnoDB;
create table products (id bigint not null auto_increment, description varchar(255), name varchar(255), primary key (id)) engine=InnoDB;
create table roles (id bigint not null auto_increment, name varchar(255), primary key (id)) engine=InnoDB;
create table users (id bigint not null auto_increment, email varchar(255), password varchar(255), primary key (id)) engine=InnoDB;
INSERT INTO roles(name) VALUES ('admin');
INSERT INTO roles(name) VALUES ('customer');
INSERT INTO users(email, password, role_id) VALUES ('admin@emprescar.com.br', '$2a$10$FIrVveP7RFnjy1ioAyEouuKnlcQdGtRv3rtOJBAmKlelbQpSFEscO', 1);
INSERT INTO customers(last_name, name, user_id) VALUES ('Emprescar', 'Admin', 1);
...
create table bookings (drop_off_date datetime(6), id bigint not null auto_increment, pick_up_date datetime(6), primary key (id)) engine=InnoDB;
create table categories (rating integer, id bigint not null auto_increment, description varchar(255), name varchar(255), url varchar(255), primary key (id)) engine=InnoDB;
create table cities (id bigint not null auto_increment, country varchar(255), name varchar(255), primary key (id)) engine=InnoDB;
create table customers (id bigint not null auto_increment, last_name varchar(255), name varchar(255), primary key (id)) engine=InnoDB;
create table features (id bigint not null auto_increment, icon varchar(255), name varchar(255), primary key (id)) engine=InnoDB;
